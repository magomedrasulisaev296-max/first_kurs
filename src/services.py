...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('cashback_analysis.log'),
...
def analyze_cashback_categories(data: List[Dict], year: int, month: int) -> str:
    try:
        ...
        monthly_data = monthly_data[
            (monthly_data['Сумма операции'] < 0) &
            (monthly_data['Категория'].notna())
            ].copy()
...
if __name__ == "__main__":
    sample_data = [
        {"Дата операции": "2024-01-15", "Категория": "Супермаркеты", "Сумма операции": -5000.0},
        {"Дата операции": "2024-01-20", "Категория": "Рестораны", "Сумма операции": -3000.0},
        {"Дата операции": "2024-02-10", "Категория": "Супермаркеты", "Сумма операции": -4000.0},
